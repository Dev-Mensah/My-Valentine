      ...
      <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4 z-50 overflow-y-auto">
        <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 sm:p-8 relative animate-scale-in my-8">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Share Your Response! 💕</h2>
            <p className="text-sm sm:text-base text-gray-600">Let them know you said YES!</p>
          </div>
          
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 border-2 border-green-200">
            <p className="text-xs sm:text-sm text-gray-600 mb-2 font-semibold">Your response link:</p>
          ...
          <div className="space-y-2 mb-4">
            <p className="text-xs sm:text-sm font-semibold text-gray-700 mb-3">Share via:</p>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6 sm:p-8 mx-4 relative animate-scale-in">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Link Created! 🎉</h2>
            <p className="text-sm sm:text-base text-gray-600">Share this special link with {formData.name}</p>
          </div>
          
          <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-xl p-3 sm:p-4 mb-6">
            <p className="text-xs sm:text-sm text-gray-600 mb-2 font-semibold">Your Valentine Proposal Link:</p>
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 sm:p-4 mb-6 rounded">
            <div className="flex items-start gap-2">
              <Sparkles className="text-yellow-500 mt-0.5 flex-shrink-0" size={18} />
              <div>
                <p className="text-xs sm:text-sm text-yellow-900 font-semibold mb-1">Pro Tip! ✨</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-200 via-purple-200 to-red-200 flex items-center justify-center p-4">
      ...
      {currentView === 'create' && (
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 max-w-md w-full mx-4">
          <div className="text-center mb-6">
            <Heart className="mx-auto mb-4 text-red-500" size={50} fill="#ef4444" />
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">Be My Valentine? 💕</h1>
            <p className="text-sm sm:text-base text-gray-600">Create a special proposal link for your crush!</p>
          </div>
      ...
      {currentView === 'proposal' && !showLongForm && (
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-12 max-w-2xl w-full mx-4 text-center relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
            ...
            <Sparkles className="absolute top-4 right-4 text-pink-400" size={20} />
            <Sparkles className="absolute bottom-4 left-4 text-red-400" size={20} />
            <Sparkles className="absolute bottom-4 right-4 text-purple-400" size={20} />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center relative px-4" style={{ minHeight: '250px' }}>
            <button
      ...
      {showLongForm && (
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-12 max-w-4xl w-full mx-4">
          ...
          <div className="text-center border-t-2 border-gray-200 pt-6">
            <p className="text-gray-600 mb-4 text-sm sm:text-base">Or you could just...</p>
            <button
              onClick={handleYesClick}
      ...
      {currentView === 'success' && (
        <>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12 max-w-2xl w-full mx-4 text-center relative z-10">
            ...
            <button
              onClick={() => window.location.href = 'https://my-favourite.vercel.app/'}
